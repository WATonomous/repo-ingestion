# Normalize the platform strings by replacing `/` with `-`
ARG NORMALIZED_TARGETPLATFORM=${TARGETPLATFORM//\//-}
ARG NORMALIZED_BUILDPLATFORM=${BUILDPLATFORM//\//-}
ARG NORMALIZED_PLATFORM=${NORMALIZED_TARGETPLATFORM:-$NORMALIZED_BUILDPLATFORM}
...
FROM base-${NORMALIZED_TARGETPLATFORM} AS base
